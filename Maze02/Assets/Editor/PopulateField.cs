...
public class PopulateField : EditorWindow
{
    ...
    static GameObject _prefab1;
    static GameObject _prefab2;
    static GameObject _prefab3;
    ...
    {
        _prefab1 = Resources.Load("Prefabs/Asteroids/Asteroid.Rock", typeof(GameObject)) as GameObject;
        _prefab2 = Resources.Load("Prefabs/Asteroids/Asteroid.Rock", typeof(GameObject)) as GameObject;
        _prefab3 = Resources.Load("Prefabs/Asteroids/Asteroid.Rock", typeof(GameObject)) as GameObject;
        _minScale = 0.1f;
        _maxScale = 1f;
        _radius = 1;
    ...
    public void OnGUI()
    {
        ...
        _prefab1 = EditorGUILayout.ObjectField(_prefab1, typeof(GameObject), false, null) as GameObject;
        _prefab2 = EditorGUILayout.ObjectField(_prefab2, typeof(GameObject), false, null) as GameObject;
        _prefab3 = EditorGUILayout.ObjectField(_prefab3, typeof(GameObject), false, null) as GameObject;
    ...
    static void SpawnAsteroid()
    {
        ...
        var _prefab = ChooseRandomPrefab();
    ...
    static GameObject ChooseRandomPrefab()
    {
